...
Creating your first serverless application can be quite intimidating. Type "serverless" into Google and you get hit with millions of results all assuming you know what you're doing.
...
Let's start with a glossary then dive into building your first serverless service. An app that says Hello 👋

## What is serverless anyway

Serverless is other people's servers running your code. The logical next step to "cloud".
...
Collocation was a solution for the bedroom or basement problem. What happens if your house catches fire? What about when power goes out? Or your mom trips on the power cable and unplugs the computer?

Residential hosting isn't very reliable. The internet is lower tier than business internet, power too. And there's nobody taking care of your server when your on vacation.

Your site might go down for a week before you even notice.

With collocation you take that same server and put it in a data center. They supply the rack space, stable power, good internet, and some physical security. You deal with configuration, maintenance, and replacing hard drives when they fail.

Yes computers break all the time. It's on you to keep it running.

### Then came virtualization

Collocation was great for physical problems, but when you realize how bored your computer gets running a website that gets 50 visitors per day ... oof.
...
The main innovation are *extremely tiny* containers, small enough to be spun up and torn down every couple of seconds. They can be so small because the code they run is:
...
Most providers offer *some* reuse to optimize speed. If it takes 100ms to spin up a server and you're getting requests faster than that, might as well leave it up, right :)
