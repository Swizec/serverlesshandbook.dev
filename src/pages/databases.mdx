...
Most real world projects use a combination of database technologies.

Files for large binary blobs, relational database for critical business data, key:value store for persistent caching, document store for complex data that always lives together.
