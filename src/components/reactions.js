...
const Reactions = ({page}) => {
  ...
  return(
    <Container>
      ...
      <ShareButtons>
        <SocialButton href={tweetUrl} title="Share on facebook" target="_blank" rel="noopener noreferrer">
        ...
        <SocialButton href={fbShareUrl} title="Share on twitter" target="_blank" rel="noopener noreferrer">
