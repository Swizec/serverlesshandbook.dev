      ...
      <JoyButton>
        ...
        <div className="Widget__WidgetLayout-sc-1ityn2x-2 cJHITu">
          ...
          <div className="styles__Flex-sc-1lygi1f-2 biiuQx">
            <a
              href={`https://spark-joy.netlify.com/c02dba9a-2eed-48d8-acd8-5b1797b5b14a/thumbsdown?instanceOfJoy=${url}`}
            ...
            <a
              href={`https://spark-joy.netlify.com/c02dba9a-2eed-48d8-acd8-5b1797b5b14a/thumbsup?instanceOfJoy=${url}`}
              className="Widget__RoundButton-sc-1ityn2x-1 caphDb"
            >
