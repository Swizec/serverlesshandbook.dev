    ...
    >
      <Box sx={{ textAlign: "center" }}>
        <h1 style={{ fontSize: "2em" }}>
          Serverless Handbook <br />
          <small style={{ fontSize: "0.5em" }}>for frontend engineers</small>
        </h1>
        Secretly this is going to be a resource teaching frontend engineers
        everything they need to know to dive into backend
      </Box>
